...
void setup() {
  ...
  background(50, 50, 50);
  rectMode(CENTER);
  map_1 = loadImage("map_1.png");
  map_2 = loadImage("map_2.png");
  map_3 = loadImage("map_3.png");
  map_load = loadImage("map_load.png");
  game_lose = loadImage("game_lose.png");
  game_start = loadImage("game_start.png");
  game_win = loadImage("game_win.png");
  game_rule = loadImage("game_rule.png");
  ...
  song = minim.loadFile("map_song.mp3");
  wow = minim.loadSample("wow.mp3");
  ohoh = minim.loadSample("ohoh.mp3");
  ohyeah = minim.loadSample("ohyeah.mp3");
  cry = minim.loadSample("cry.mp3");
  baba = minim.loadSample("baba.mp3");
  reset();
